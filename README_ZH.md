...
## 三十秒上手 · Try it in 30 seconds

体验万神殿，不需要你先上传逝去亲人的聊天记录。

```bash
/pantheon-demo
```

This command installs a fully built fictional Chinese family (**王家** — 爷爷, 奶奶, 老爸) into `~/.pantheon/`. 三代人，所有命令立刻可用。

安装完成后：

```
/pantheon-talk father_wangjianguo                                   # 和老爸对话
/pantheon-tree                                                       # 看家族图谱
/pantheon-dna                                                        # 三代人的"倔"是怎么传下来的
/pantheon-ritual                                                     # 外婆的红烧肉
/pantheon-family grandma_zhangxiuying father_wangjianguo            # 群聊
```

王家的完整设定见 [`examples/wang_family/README.md`](examples/wang_family/README.md)。所有角色都是虚构的。
